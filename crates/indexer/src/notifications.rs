...
pub async fn notify_nivsters_dispute_resolved<'a>(
    ...
    let notification_type = match dispute_event_type {
        ...
        DISPUTE_DEFAULTED => NIVSTER_DISPUTE_RESOLVED_DEFAULTED,
